...
def home():
	projects = [
  ...
  
		{
			...
			"description": (
				"Predicts graduate admission likelihood using academic profile features and an MLP classifier." 
    			"Includes preprocessing, feature alignment, probability scoring, and a Streamlit interface for real-time prediction."
			),
